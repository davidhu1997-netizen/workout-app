      ...
      exercises: [
        ...
        },
        {
          ...
          formCues: [
            ...
            'Lower the dumbbells to chest level, then press up',
        ...
        },
        {
          ...
          reps: 12,
          defaultWeight: 40,
          equipmentLabel: 'Cable machine at 40 lb',
          formCues: [
            'Sit tall with feet on the platform',
        ...
        },
        {
          ...
          reps: 10,
          defaultWeight: 10,
          equipmentLabel: 'Two 10 lb dumbbells',
          formCues: [
        ...
        },
        {
          ...
          formCues: [
            ...
            'Curl up slowly, squeeze at the top',
      ...
      exercises: [
        {
          ...
          formCues: [
            ...
            'Adjust the seat so your knees don\'t lock',
          ],
        },
        {
          id: 'ex-goblet-squat',
          ...
          reps: 10,
          defaultWeight: 20,
          equipmentLabel: 'One 20 lb dumbbell',
          formCues: [
            'Hold the dumbbell at your chest with both hands',
        ...
        },
        {
          ...
          reps: 12,
          defaultWeight: 90,
          equipmentLabel: 'Leg press machine at 90 lb',
          formCues: [
        ...
        },
        {
          ...
          reps: 12,
          defaultWeight: 30,
          equipmentLabel: 'Leg curl machine at 30 lb',
          formCues: [
            'Adjust the pad to sit just above your ankles',
            'Curl your legs down slowly',
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          reps: 10,
          defaultWeight: 20,
          equipmentLabel: 'Two 20 lb dumbbells',
          formCues: [
            'Keep a neutral spine by looking forward and bracing your core',
            'Drive through your heels as you stand up',
          ],
          commonMistakes: [
            'Letting knees track over toes too far',
        ...
        },
        {
          ...
          reps: 10,
          defaultWeight: 15,
          equipmentLabel: 'One 15 lb dumbbell',
          formCues: [
        ...
        },
        {
          ...
          reps: '45s',
          defaultWeight: 0,
          equipmentLabel: 'Bodyweight (add plate on back if comfortable)',
          formCues: [
        ...
        },
        {
          ...
          reps: 12,
          defaultWeight: 40,
          equipmentLabel: 'Lat pulldown machine at 40 lb',
          formCues: [
...
export function seedSchedule(): ScheduledWorkout[] {
  ...
  return [
    {
      ...
      scheduledDate: toISODate(monday),
      status: 'completed',
    ...
    },
    {
      ...
      scheduledDate: toISODate(wednesday),
      status: 'upcoming',
    },
    {
      id: 'sched-fri',
      templateId: 'tmpl-full',
      scheduledDate: toISODate(friday),
      status: 'upcoming',
    },
  ]
}

export function seedCompletedSession(): WorkoutSession {
  const { monday } = getWeekDates()
  const startTime = new Date(monday)
  startTime.setHours(9, 0, 0)
  const endTime = new Date(monday)
  endTime.setHours(9, 38, 0)

  const template = seedTemplates()[0]

  const exercises: ExerciseSession[] = template.exercises.map((ex) => ({
    exerciseId: ex.id,
